...
const About = () => {
  ...
  useEffect(() => {
    fetch('https://reqres.in/api/users?page=2')
      .then(res => res.json())
      .then(data => setmyuserdata(data.data));
  }, []);
  ...
  return (
    <>
      ...
      <p className="about-para">
        ...
        incluye versiones de Lorem Ipsum. Es un hecho establecido hace demasiado
        tiempo que un lector se distraerá con el contenido del texto de un sitio
        ...
        insertándole humor y cosas por el est
      </p>
    </>
  );
};
